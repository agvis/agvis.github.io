---
title: ""
authors: "Anjuli Jain and Joy Yang"
output:
  html_document:
...
Advances in technology has allowed large industrial operations to excel at producing large quantities of one product efficiently, and so large farms can achieve economies of scale more readily. The cost of these technologies has made it very difficult for midsized farms to compete. But at what point is large too large? Have certain regions of the US already hit this point? While this is a very rough graph, the answer is likely, yes, farm sizes in some regions of the US may already be beyond the point of diminishing returns. Bigger may not always better.
...
So diversification seems like a good strategy, it helps reduce and mitigate risks and provides consumers with more variety. However, from the diversity maps, we can see that counties across the U.S. skew toward monoculture. The immediate gains of monoculture are just too tempting.

While the analogy is not perfect, we find the tilt toward riskier practices that large farms are adopting is uncomfortably reminiscent of the risk seeking behavior undertaken by large banks. Is there anything that the government can do to reverse the incentives? What do the current policies incentivize?


## Government payments

The question is, what is the role of government payments? Should government payments (1) protect farmers against price shocks so that they don’t lose everything if a bad year hits? (2) incentivize farmers to produce enough food so that people don’t go hungry? (3) make sure that farms don’t overtake natural wildlife? The U.S Farm Bill encompasses all three goals. The bill helps codify crop insurance in the U.S and has huge impact on what is grown, produced and eaten. The Farm Bill can be rather controversial. Some consider it “welfare for the well-off” and others highlight its importance to stable food supply.  Regardless of the view, we wanted to know who gets the subsidies?

In asking this question, we encountered the paradoxical situation that the largest amount of government payments happen to be going to areas with the highest market value of commodities. This is because the largest farms have the highest market value of commodities, but the largest farms also receive the highest amounts in government payments. Additionally, the amount of government payments is actually calculated based on market value of the commodities. So there's a positive feedbackloop. And oddly enough, farmers receive [large payments on good years and very little on bad years](https://www.farmaid.org/blog/farm-bill-101/).
...
So we can't help but wonder, is this a desirable situation? Is this a dangerous situation? Could these positive feedback loops be conducive to large farms becoming too big to fail?
