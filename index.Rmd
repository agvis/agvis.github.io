...
![](images/mosaicDiversityThinLight.png) 
...
m.labels = lapply(paste(farmmap@data$county,", ",farmmap@data$state,
				" <br/>Average Farm Size: ",round(2^a*100)/100," times change",
				" <br/>Number of Farms: ",round(2^b*100)/100," times change",sep=""),
				htmltools::HTML)
...
We mapped the data on two metrics:
...
<font size="4"> Aside: What’s going on in Arizona?? </font> 
In looking at the spending maps, Apache, Navajo and Coconino counties in Arizona all stood out. This region had low subsidies any way you cut it (government spending per acre or government spending per farm). Coincidentally they had high diversity with medium sized farms. They also stood out in their parity in farmer genders with nearly 50% of farm operators being women (much above the national average of [15% ](link: https://www.agcensus.usda.gov/Publications/2007/Online_Highlights/Fact_Sheets/Demographics/women.pdf); <!--- Check this number ---> . We were curious why this region was such an outlier. We took some time to investigate what was happening there. Here are some fun findings.
The outlier region is Navajo Nation, and like many of the other Indian reservations, it’s quite poor. A look at [this map](link: https://fr.m.wikipedia.org/wiki/Fichier:Americanindiansmapcensusbureau.gif); of US Indian reservations (over 300) was enlightening. 

As a sovereign nation, it seems the government did not provide much ag subsidy or the Navajo Nation did not participate in the crop insurance. This seems to have [changed more recently](https://nativenewsonline.net/currents/crop-insurance-continues-to-yield-benefits-for-navajo-farmers/) in 2016 and got a [return](http://www.navajonationcouncil.org/pressReleases/2018/Feb/Agricultural_insurance_investment_earns_the_Navajo_Nation_over_$17_million_for_agricultural_infrastructure_projects.pdf) in 2018 on insurance they purchased.
...
<!--- 
<div id="left">
  ![](images/temp/Government_Spending_Per_Acre_Of_Farmland.png)
</div>

<div id="right">
  ![](images/temp/Government_Spending_Per_Farm.png)
</div>
--->

Despite these 2 metrics, some regions gain and loose regardless of the metric. Such as east North Dakota, parts of Louisiana and Arkansa.

In particular, we wondered, what’s going on in Arizona?
In looking at the maps, counties Apache, Navajo and Coconino in Arizona all stood out. This region had low subsidies any way you cut it (government spending per acre or government spending per farm). Coincidentally they had high diversity with medium sized farms. They also stood out in their parity in farmer genders with nearly 50% of farm operators being women (much above the national average of [15% ](link: https://www.agcensus.usda.gov/Publications/2007/Online_Highlights/Fact_Sheets/Demographics/women.pdf); <!--- Check this number ---> . We were curious why this region was such an outlier. We took some time to investigate what was happening there. Here are some fun findings.
The outlier region is Navajo Nation, and like many of the other Indian reservations, it’s quite poor. A look at [this map](link: https://fr.m.wikipedia.org/wiki/Fichier:Americanindiansmapcensusbureau.gif); of US Indian reservations (over 300) was enlightening. 
...
Data from the 2017 Agricultural Census is set to be released early 2019. We'll be waiting to see whether anything has changed.
